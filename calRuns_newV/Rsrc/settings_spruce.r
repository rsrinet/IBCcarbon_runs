...
devtools::source_url("https://raw.githubusercontent.com/rsrinet/IBCcarbon_runs/refs/heads/master/general/functions_spruce.r")
...
if(!exists("pPRELES")) pPRELES <- pPREL
...
# varOuts[4] <- varNames[43] <- "grossGrowth"
